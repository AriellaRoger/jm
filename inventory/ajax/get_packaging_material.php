<?php
// File: inventory/ajax/get_packaging_material.php
// AJAX handler for getting single packaging material for editing
...
try {
    ...
    $material = $inventoryController->getPackagingMaterialById($materialId);
