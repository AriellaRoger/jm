<?php
// File: fleet/ajax/get_machine_expenses.php
// Get expenses for a specific machine
...
// Only administrators and supervisors can view machine expenses
...
try {
    ...
    // Get expenses for this machine
    $expenses = $fleetController->getMachineExpenses($machineId);
    ...
    error_log("Get machine expenses error: " . $e->getMessage());
